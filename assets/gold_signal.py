...
def generate_gold_signal_with_score(data):
    """
    Generate Gold (XAUUSD) trading signal with confidence scoring.
    Input:
        data - price data DataFrame for Gold
    Returns:
    ...
    alert_msg = (
        f"{emoji} Gold {signal} Signal ({total_score}/6 Confidence: {confidence})\n"
